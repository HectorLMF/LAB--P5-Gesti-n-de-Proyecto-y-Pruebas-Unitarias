...
public class DominanceTest {
    ...
    void testClearDominanceMaximization() {
        ...
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(6.0, 5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(4.0, 3.0));
    ...
    void testNoDominanceYBetterMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(3.0, 2.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0, 6.0));
    ...
    void testPartialDominanceMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(7.0, 5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(7.0, 5.0));
    ...
    void testDominanceOneBetterMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(6.0, 5.0, 5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0, 5.0, 5.0));
    ...
    void testTradeoffNonDominatedMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(10.0, 2.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(3.0, 9.0));
    ...
    void testClearDominanceMinimization() {
        ...
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(2.0, 3.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0, 6.0));
    ...
    void testNoDominanceYBetterMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(8.0, 9.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(2.0, 3.0));
    ...
    void testDominanceOneBetterMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(3.0, 5.0, 5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0, 5.0, 5.0));
    ...
    void testTradeoffNonDominatedMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(2.0, 10.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(9.0, 3.0));
    ...
    void testEqualSolutionsMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(5.0, 5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0, 5.0));
    ...
    void testEqualSolutionsMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(3.0, 3.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(3.0, 3.0));
    ...
    void testThreeObjectiveDominanceMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(6.0, 7.0, 8.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0, 6.0, 7.0));
    ...
    void testThreeObjectiveNonDominance() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(8.0, 5.0, 2.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(3.0, 7.0, 9.0));
    ...
    void testFourObjectiveDominanceMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(1.0, 2.0, 3.0, 4.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(2.0, 3.0, 4.0, 5.0));
    ...
    void testFiveObjectivePartialDominance() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(7.0, 6.0, 5.0, 5.0, 5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(6.0, 5.0, 5.0, 5.0, 5.0));
    ...
    void testListDominanceAddsNonDominated() {
        ...
        when(existing.getEvaluation()).thenReturn(Arrays.asList(10.0, 2.0));
        List<State> list = new ArrayList<>();
        list.add(existing);
        
        // New non-dominated solution
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(3.0, 9.0));
        when(solutionX.getCopy()).thenReturn(solutionX);
    ...
    void testListDominanceRemovesDominated() {
        ...
        when(dominated.getEvaluation()).thenReturn(Arrays.asList(3.0, 3.0));
        List<State> list = new ArrayList<>();
        list.add(dominated);
        
        // Dominant solution
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(6.0, 6.0));
        when(solutionX.getCopy()).thenReturn(solutionX);
        when(solutionX.Comparator(any())).thenReturn(false);
    ...
    void testListDominanceRejectsDominated() {
        ...
        when(dominant.getEvaluation()).thenReturn(Arrays.asList(10.0, 10.0));
        List<State> list = new ArrayList<>();
        list.add(dominant);
    ...
    void testListDominanceRejectsDuplicate() {
        ...
        // Existing solution
        State existing = mock(State.class);
        when(existing.getEvaluation()).thenReturn(Arrays.asList(5.0, 5.0));
        List<State> list = new ArrayList<>();
        list.add(existing);
    ...
    void testListDominanceMultipleSolutions() {
        ...
        when(state2.getEvaluation()).thenReturn(Arrays.asList(5.0, 7.0));
        List<State> list = new ArrayList<>();
        list.add(state1);
        list.add(state2);
    ...
    void testListDominanceRemovesMultipleDominated() {
        ...
        State state1 = mock(State.class);
        when(state1.getEvaluation()).thenReturn(Arrays.asList(5.0, 6.0));
        State state2 = mock(State.class);
        when(state2.getEvaluation()).thenReturn(Arrays.asList(7.0, 8.0));
        List<State> list = new ArrayList<>();
        list.add(state1);
        list.add(state2);
        
        // Dominant solution
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(3.0, 4.0));
        when(solutionX.getCopy()).thenReturn(solutionX);
        when(solutionX.Comparator(any())).thenReturn(false);
    ...
    void testSingleObjectiveDominanceMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(7.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0));
    ...
    void testSingleObjectiveDominanceMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(3.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0));
    ...
    void testSingleObjectiveEqual() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0));
    ...
    void testZeroValuesMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(1.0, 0.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(0.0, 0.0));
    ...
    void testNegativeValuesMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(-5.0, -6.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(-3.0, -4.0));
    ...
    void testMixedPositiveNegativeValues() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(-2.0, 5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(-5.0, 3.0));
    ...
    void testEpsilonDifferences() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(1.0000001, 2.0000001));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(1.0, 2.0));
    ...
    void testVeryLargeValues() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(1e10, 1e11));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(1e9, 1e10));
    ...
    void testVerySmallValues() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(1e-10, 1e-11));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(1e-9, 1e-10));
    ...
    void testListDominanceSingleElementDominated() {
        ...
        State dominated = mock(State.class);
        when(dominated.getEvaluation()).thenReturn(Arrays.asList(2.0, 2.0));
        List<State> list = new ArrayList<>();
        list.add(dominated);
    ...
    void testDominanceSymmetry() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(10.0, 5.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(5.0, 10.0));
    ...
    void testDominanceTransitivity() {
        ...
        when(solutionX.getEvaluation()).thenReturn(Arrays.asList(8.0, 8.0));
        when(solutionY.getEvaluation()).thenReturn(Arrays.asList(6.0, 6.0));
        when(solutionZ.getEvaluation()).thenReturn(Arrays.asList(4.0, 4.0));
    ...
    void testListDominancePreservesNonDominatedProperty() {
        ...
        State state1 = mock(State.class);
        when(state1.getEvaluation()).thenReturn(Arrays.asList(10.0, 3.0));
        when(state1.getCopy()).thenReturn(state1);
        when(state1.Comparator(any())).thenReturn(false);
        
        State state2 = mock(State.class);
        when(state2.getEvaluation()).thenReturn(Arrays.asList(5.0, 8.0));
