...
public class AcceptNotDominatedTest {
    ...
    void testEmptyParetoFrontInitialization() {
        ...
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 3.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(6.0, 4.0)));
    ...
    void testCandidateDominatedByCurrentMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(6.0, 5.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(4.0, 3.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
    ...
    void testNonDominatedSolutionsMaximization() {
        ...
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(8.0, 3.0)));
        // Candidate: worse in obj1, better in obj2
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 6.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testCandidateEqualToCurrentMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 5.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 5.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
    ...
    void testCandidateDominatesCurrentMinimization() {
        ...
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 4.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(3.0, 2.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testCandidateDominatedByCurrentMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(2.0, 3.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 6.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
    ...
    void testNonDominatedSolutionsMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        // Current: better in obj1, worse in obj2
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(2.0, 8.0)));
        // Candidate: worse in obj1, better in obj2
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 3.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testThreeObjectiveDominanceMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 4.0, 3.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(6.0, 5.0, 4.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testThreeObjectiveNonDominatedMaximization() {
        ...
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(8.0, 5.0, 2.0)));
        // Worse in obj1, equal in obj2, better in obj3
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(6.0, 5.0, 7.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testFourObjectiveDominanceMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 6.0, 7.0, 8.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(4.0, 5.0, 6.0, 7.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testCandidateRemovesDominatedFromFront() {
        ...
        when(dominatedState.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(3.0, 2.0)));
        strategy.listRefPoblacFinal.clear();
        ...
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(6.0, 5.0)));
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testCandidateRejectedByFrontMember() {
        ...
        when(dominantState.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(10.0, 10.0)));
        strategy.listRefPoblacFinal.clear();
        strategy.listRefPoblacFinal.add(dominantState);
        
        // Current state
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(8.0, 8.0)));
        
        // Candidate is worse than front member
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(7.0, 7.0)));
    ...
    void testMultipleNonDominatedAddedToFront() {
        ...
        // Current state
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(8.0, 4.0)));
        
        // Candidate: non-dominated (trade-off)
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 8.0)));
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
    ...
    void testWithZeroValuesMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(0.0, 0.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(1.0, 1.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testWithEpsilonValues() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(1.0000001, 2.0000001)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(1.0000002, 2.0000002)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testPartialDominanceBetterInOneMaximization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 5.0, 5.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(6.0, 5.0, 5.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testNoDominanceTradeoff() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(10.0, 2.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(3.0, 9.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testSingleObjectiveMaximizationBetter() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(7.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testSingleObjectiveMinimizationWorse() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(3.0)));
    ...
    void testWithVeryLargeValues() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(1e10, 1e10)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(1e11, 1e11)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testWithVerySmallValues() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(1e-5, 1e-5)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(1e-6, 1e-6)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testMixedPositiveNegativeValues() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MAXIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(-5.0, 10.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(-3.0, 12.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testLargeParetoFront() {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            when(state.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(10.0 - i, 2.0 + i)));
        ...
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(4.0, 8.0)));
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testCandidateAlreadyInFront() {
        ...
        when(existingState.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 5.0)));
        strategy.listRefPoblacFinal.clear();
        strategy.listRefPoblacFinal.add(existingState);
        
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(4.0, 4.0)));
    ...
    void testAllEqualExceptOneMinimization() {
        when(mockProblem.getTypeProblem()).thenReturn(ProblemType.MINIMIZAR);
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 5.0, 5.0, 5.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 5.0, 5.0, 3.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
    ...
    void testSymmetricalNonDominance() {
        ...
        when(stateCurrent.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(10.0, 5.0)));
        when(stateCandidate.getEvaluation()).thenReturn(new ArrayList<>(Arrays.asList(5.0, 10.0)));
        when(stateCurrent.getCopy()).thenReturn(stateCurrent);
        when(stateCandidate.getCopy()).thenReturn(stateCandidate);
        when(stateCandidate.Comparator(any())).thenReturn(false);
